        ...
        return(
            ...
            <div key={this.props.index} className="word" >  
                ...
                <label className="favorite"> 
                        <input type="checkbox" name="favorite" ref={(input) => this.favorite = input}  checked={word.favorite} onClick={(e) => this.props.actions.changeValue(this.props.index,word, e.target.name, e.target.checked)}/>
